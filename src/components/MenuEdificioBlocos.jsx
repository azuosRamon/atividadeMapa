...
function BlocosOpcoes({ dados }) { 
    ...
    useEffect(() => {
        SelectBancoDeDados({nomeTabela: 'campi', setData: setListaCampus, setLoading: setLoading })
    }, [])
                    ...
                    <FormGrid onSubmit={fazerEnvio}>
                        ...
                        <GridArea $area="operacao">
                            <Label htmlFor="operacao">Operacao:</Label>
                                <Select autoFocus id="operacao" name="operacao" required onChange={(e) => {setOperacao(e.target.value); alterarObjeto(e, 'bloco_id')}}>
                        ...
                        <GridArea $area="campusId">
                            <Label htmlFor="campusId">Selecione o campus:</Label>
                                <Select autoFocus id="campusId" name="campusId" required onChange={(e) => {setOperacao(e.target.value); alterarObjeto(e, 'campus_id')}}>
                                {!loading &&
                        ...
                        <GridArea $area="blocosId">
                            ...
                            <Input type="number" id="blocosId" name="blocosId" alt="Apenas para alteração ou exclusão" disabled={!operacao || Number(operacao)<=1} onChange={(e) => alterarObjeto(e, 'bloco_id')}/>
                        </GridArea>
                        <GridArea $area="nome">
