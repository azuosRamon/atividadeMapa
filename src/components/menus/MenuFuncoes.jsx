                ...
                <FormGrid onSubmit={fazerEnvio}>
                    ...
                    <GridArea $area="operacao">
                        <Label htmlFor="operacao">Operacao:</Label>
                            <Select id="operacao" autoFocus name="operacao" required onChange={(e) => {setOperacao(e.target.value); alterarObjeto(e, 'funcao_id')}}>
                    ...
                    <GridArea $area="id">
                        ...
                        <Input type="number" id="id" name="id" disabled={!operacao || Number(operacao)<=1} onChange={(e) => alterarObjeto(e, 'funcao_id')}/>
                    </GridArea>
                    <GridArea $area="nome">
